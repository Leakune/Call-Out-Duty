...
if($_SESSION["status"] == 2)
{
    ...
    $connect = connectDb();
        ...
        $data_users = $connect->query("SELECT *, users.id providerId
         FROM users, address, user_has_address, address_has_city, city
          WHERE
...
<!-- barre de recherche -->
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="margin-top: 15%;">
      <div class="form-inline">
        ...
        <input class="form-control" type="text" id="search-prestataires" placeholder="<?= SEARCH_BAR_CLIENT ?>" name="search">
        <input class="btn btn-outline-info my-2 my-sm-0" type="submit" value="<?= SEARCH_BAR ?>" onclick="search_prestataires()">
  ...
  <!--  -->
    ...
    //Attribution des adresses respectives à chaque user
            ...
            foreach ($data_users->fetchAll() as $users)
            {
              ...
              //Vérification de la disponibilité des prestataires
              ...
              echo "<td>".'<a class="btn btn-secondary" href="assign-provider.php?id='.$users['providerId'].'">Affecter ce prestataires à un client</a>'."</td>";
              echo "</tr>";
            }
        ...
        <!-- Nested Row within Card Body -->
            <div class="p-5">
              <div class="text-center">
                <h1 id="add" class="h4 text-gray-900 mb-4">Ajouter un prestataire</h1>
              </div>
