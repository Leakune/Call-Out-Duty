...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <?php
      ...
      $header = new Header('#','planning/ges-planning.php','#','login-home/abonnements/buy-subscriptions.php','login-home/categories/category.php','#','#', '#'); 
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <table class="table">
                    ...
                    require_once 'services/display-services.php';
