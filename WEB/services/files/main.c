// gcc main.c -o main -lopengl32 -lglu32 -lglut32
...
float distanceEpauleX = -1.0;
float distanceEpauleY = 0.0;
float distanceEpauleZ = 0.0;
...
void display(){
	...
	droite de lma matrice active, ici l'identité*/
...
// glTranslate(a, b, c);
// //En cliquant sur a, b, c on peut se déplacer sur x, y ou z
...
void update(int value)
{
	...
	cameraAngle = epaule - cameraAngle;
