      ...
      <div class="cell example example3" id="example-3">
        <form action="payment.php" method="post" id="payment_form">
          <div class="fieldset">
            ...
            <input id="example3-email" data-tid="elements_examples.form.email_label" class="field half-width" type="email" placeholder="Email" required="" autocomplete="email" value="projet@gmail.fr">
