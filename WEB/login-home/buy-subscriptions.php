...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Source+Code+Pro" rel="stylesheet">
	...
	<link rel="stylesheet" type="text/css" href="example3.css" data-rel-css="" />
</head>
<body>
    ...
    <section class="container-lg">
      ...
      <div class="cell example example3" id="example-3">
        <form action="payment.php" method="post" id="payment_form">
          <div class="fieldset">
            <input id="example3-name" data-tid="elements_examples.form.name_label" class="field" type="text" placeholder="Name" required="" autocomplete="name" value="Ludo">
            <input id="example3-email" data-tid="elements_examples.form.email_label" class="field half-width" name="email" type="email" placeholder="Email" required="" autocomplete="email" value="projet@gmail.fr">
            <input id="example3-phone" data-tid="elements_examples.form.phone_label" class="field half-width" type="tel" placeholder="Phone" required="" autocomplete="tel" value="0123456789">
          </div>
          <div class="fieldset">
  ...
  <script src="example3.js" data-rel-js></script>
