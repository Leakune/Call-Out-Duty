    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      ...
      ?>
              ...
              <form class="user" method="POST">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="email" class="form-control form-control-user" name="mail" placeholder="Mail" >
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="password" class="form-control form-control-user" name="pwdConfirm" placeholder="Confirmation du mot de passe">
                  </div>
                </div>
